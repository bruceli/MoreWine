...
- (void)addDimView{
    ...
    self.dimView.backgroundColor = [UIColor redColor];
...
- (void)addContainerView{
    CGSize contentSize = CGSizeMake(((ADDropDownMenuItemView *)[self.itemsViews firstObject]).frame.size.width, ((ADDropDownMenuItemView *)[self.itemsViews firstObject]).frame.size.height * self.itemsViews.count);
    self.containerView = [[UIScrollView alloc] initWithFrame: ((ADDropDownMenuItemView *)[self.itemsViews firstObject]).bounds];
